...
- If the question asks to list items (projects, skills, experience, certifications, etc.), list EVERY item present in the context — do not omit any.
- If the question asks about personal information (name, email, phone, contact), look carefully through ALL context chunks.
...
- إذا كان السؤال يطلب سرد عناصر (مشاريع، مهارات، خبرات، شهادات، إلخ)، قم بسرد كل عنصر موجود في السياق — لا تحذف أيًا منها.
- إذا كان السؤال عن معلومات شخصية (اسم، بريد إلكتروني، هاتف، جهة اتصال)، افحص جميع أجزاء السياق بعناية.
